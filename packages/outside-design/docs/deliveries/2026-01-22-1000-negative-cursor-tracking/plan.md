...
- `packages/outside-client/src/renderer/visualDebugLayer.ts`
- Optional: `packages/outside-client/src/renderer/coordinateSystem.test.ts` for negative-coordinate conversion checks.
