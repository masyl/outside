...
Created a new UI component `[packages/outside-client/src/debug/connectionOverlay.ts](packages/outside-client/src/debug/connectionOverlay.ts)` to display connection status messages.
...
Updated `[packages/outside-client/src/network/client.ts](packages/outside-client/src/network/client.ts)` to support manual reconnection.
...
Updated `[packages/outside-client/src/main.ts](packages/outside-client/src/main.ts)` to wire up the reconnection logic.
