...
### 1. SelectionManager (`packages/outside-client/src/input/selection.ts`)
...
### 2. KeyboardHandler (`packages/outside-client/src/input/keyboardHandler.ts`)
...
### 3. Renderer Updates (`packages/outside-client/src/renderer/objects.ts`, `packages/outside-client/src/renderer/renderer.ts`)
...
### 4. Mock Command Feeder Update (`packages/outside-client/src/mock/commandFeeder.ts`)
...
### 5. Game Loop Optimization (`packages/outside-client/src/game/loop.ts`)
...
### 6. Animation Duration Update (`packages/outside-client/src/game/animations.ts`, `packages/outside-client/src/game/animationController.ts`)
...
### 7. Integration (`packages/outside-client/src/main.ts`)
...
- `packages/outside-client/src/input/selection.ts` - SelectionManager class
- `packages/outside-client/src/input/keyboardHandler.ts` - KeyboardHandler class

### Modified Files

- `packages/outside-client/src/main.ts` - Integration of input system
- `packages/outside-client/src/renderer/objects.ts` - Color support for selection
- `packages/outside-client/src/renderer/renderer.ts` - Selection state and color updates
- `packages/outside-client/src/mock/commandFeeder.ts` - 3 bots instead of 1
- `packages/outside-client/src/game/loop.ts` - 125ms interval
- `packages/outside-client/src/game/animations.ts` - 125ms duration
- `packages/outside-client/src/game/animationController.ts` - 125ms duration
