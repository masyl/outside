...
- Timeline component (`packages/outside-client/src/components/Timeline.tsx`) ✅
- TimelineManager (`packages/outside-client/src/timeline/manager.ts`) ✅
- Storybook setup (`packages/outside-storybook/`) ✅
- Pixi-React setup (`packages/outside-client/src/pixi-setup.ts`) ✅
- @pixi/ui library ✅
