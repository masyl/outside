...
2. Build a basic local CLI tool (using Deno 2 and Cliffy) for track management. The project `/skills` files will be updated to call into this CLI tool to ensure predictable and scripted environment controls.
...
- Creating a Deno 2 CLI tool using Cliffy for predictable track lifecycle scripts.
...
- Upgrade the Deno 2 CLI tools utilizing a high-performance ECS TUI system (see related pitch: [Generalize Outside for TUI Games](./generalize-outside-for-tui-games.md))
