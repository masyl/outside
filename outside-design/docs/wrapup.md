...
- If the delivery document has not already been placed in the correct folder, create folder in `outside-design/docs/deliveries/`
...
- Candidate pitches are located in `outside-design/docs/pitches/`
