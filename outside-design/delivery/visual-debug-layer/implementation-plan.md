...
**File**: `/outside-client/src/renderer/visualDebugLayer.ts`
...
**File**: `/outside-client/src/renderer/renderer.ts`
...
**Files**: `/outside-client/src/main.ts`, `/outside-client/src/renderer/visualDebugLayer.ts`
