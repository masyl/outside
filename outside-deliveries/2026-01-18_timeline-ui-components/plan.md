...
- **NEW**: `outside-client/src/ui/timelineBar.ts` - Main timeline component
- **MODIFY**: `outside-client/src/main.ts` - Integration and initialization
- **MODIFY**: `outside-client/src/timeline/manager.ts` - Enhanced position callbacks
